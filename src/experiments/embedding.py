"""
Testing encoder inputs and decoder outputs in the same embedding space.
"""
import json
import numpy as np
import pandas as pd
...
results_file = "results/embed.txt"
...
class Negotiator(TfEncoderDecoder):
	...
	def _define_embedding(self):
		"""
		Key modifications:
		 - Uses a single embedding space for inputs and outputs
		"""
